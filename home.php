...
<div style="height: 500px;">
  <div id="d79549">
    ...
    <select id="villeE" name="villeE" required value="<?php echo $ville ?>">
    ...
    <span class="label-expid">*</span>
    <select id="villeD" name="villeD" required value="<?php echo $ville ?>">
      <option value="">-- Choisir Une Ville --</option>
      <option value="Ariana">Ariana</option>
      <option value="Beja">Beja</option>
      <option value="Ben Arous">Ben Arous</option>
 ...
 <style>
  ...
  <div id="d79547">
    ...
    <ul class="amx-cp-list amx-mr-link-list">
      ...
      <li class="li-colis">
      <a href="steps/preparer_commande.php">
