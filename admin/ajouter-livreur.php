    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 offset-md-4 form">
                <form action="../login-signup/signup-user.php" method="POST" autocomplete="">
                    <h2 class="text-center">Ajout de livreur</h2>
                    <?php
                    if(count($errors) == 1){
                        ?>
                    ...
                    <div class="form-group">
                        <input class="form-control button" type="submit" name="ajouter" value="S'inscrire">
                    </div>
